 ...
 */
public class SendHttpProcessCuso {

    private static final Logger log = Logger.getLogger(SendHttpProcessCuso.class);
...
//        new SendHttpProcess().sendHttpRequest("http://116.90.162.170:10809/rest/biller/inquirytransaction", text);
        String a = new SendHttpProcessCuso().sendHttpRequest("http://49.0.0.189/cuso_api/login.php?token=F8H305AA9954EB70&cuid=0001&username=0.01.00041&password=07031961", "");
