 ...
 * @author herrysuganda
 */
public class ListTransactionBackend {

    private static Logger log = Logger.getLogger(ListTransactionBackend.class);

    public HashMap process(HashMap input) throws ParseException {
        BackendDBProcess dp = new BackendDBProcess();
        ArrayList<Reportyabes> ListTrx = dp.getAlltransactionyabes();
        Gson gson = new Gson();
