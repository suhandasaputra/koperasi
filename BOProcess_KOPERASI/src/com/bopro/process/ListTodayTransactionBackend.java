 ...
 * @author herrysuganda
 */
public class ListTodayTransactionBackend {

    private static Logger log = Logger.getLogger(ListTodayTransactionBackend.class);

    public HashMap process(HashMap input) throws ParseException {
        BackendDBProcess dp = new BackendDBProcess();
        ArrayList<Reportyabes> ListTrx = dp.getTodayTransaction();
        Gson gson = new Gson();
