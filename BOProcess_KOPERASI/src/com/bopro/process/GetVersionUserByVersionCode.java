 ...
 * @author herrysuganda
 */
public class GetVersionUserByVersionCode {

    private static Logger log = Logger.getLogger(GetVersionUserByVersionCode.class);

    public HashMap process(HashMap input) throws ParseException {
        BackendDBProcess dp = new BackendDBProcess();
        HashMap result = dp.getVersionUserByVersionCode(input.get("versioncode").toString());
