 ...
 * @author herrysuganda
 */
public class ListThisMonthTransaction {

    private static Logger log = Logger.getLogger(ListThisMonthTransaction.class);

    public HashMap process(HashMap input) throws ParseException {
        BackendDBProcess dp = new BackendDBProcess();
        ArrayList<Reportyabes> ListTrx = dp.getThisMonthTransaction();
        Gson gson = new Gson();
