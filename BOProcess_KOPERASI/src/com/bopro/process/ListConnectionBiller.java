 ...
 * @author herrysuganda
 */
public class ListConnectionBiller {

    private static Logger log = Logger.getLogger(ListConnectionBiller.class);

    public HashMap process(HashMap input) throws ParseException {
        BackendDBProcess dp = new BackendDBProcess();
        ArrayList<Connectionbiller> cbiller = dp.getAllConnectionbillers();
        Gson gson = new Gson();
