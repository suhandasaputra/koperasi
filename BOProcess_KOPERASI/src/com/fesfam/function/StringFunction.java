...
public class StringFunction {
    ...
    public static String getCurrentDateYYYYMMDDHHMMSS() {
     ...
     public static String getCurrentDateMMDDHHMMSSSS() {
        GregorianCalendar calendar = new GregorianCalendar();
        SimpleDateFormat formatter = new SimpleDateFormat("MMddHHmmssSS");
        String s = formatter.format(calendar.getTime());
        return s;
    }
...
//    public static String getCurrentDateMMDDHHMMSS(GregorianCalendar calendar) {
